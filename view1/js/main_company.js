...
function add_jobs(arr)
{
  ...
  var applicants=document.createElement("label");
  applicants.innerHTML="<br>Total Applicants :-"+arr.applicants.length+"<br>";
  ...
  outerdiv.addEventListener("click",function()
  {
    ...
    job_desc1.style.display="block";
     ...
     already_interest.innerHTML="Already Saved";
     already_interest.style.background="#009999";
     already_interest.style.color="white";
     already_applied.innerHTML="Already applied";
     already_applied.className="button";
     already_applied.style.background="#009999";
     already_applied.style.color="white";
     ...
     my_interest.addEventListener("click",function()
     {
      ...
      xhttp.open("GET","/company_interested_jobs?id="+arr.id,true);
      xhttp.send();
     });
  });
  return outerdiv;
